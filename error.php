  ...
  <div class="der">
      <div class="container">
        ...
        <div class="forms">
            ...
            <br><br>
            <form class='row' autocomplete="off" action="insertarpaciente-post.php" method="post">
            <div class="col-md-4">
            ...
            <div class="col-md-2">
              ...
              <input type="date"  name="feccre" value="2010-06-01"/>
            </div>
            <div class="col-md-4">
                <br><br>
              <label class="form-label">Telf. de referencia</label>
              <input type="number" name="numtelf" class="form-control">
            </div>
            <div class="col-md-3">
                <br><br>
            ...
            <div class="col-md-12">
              <br><br>
              <button class="btn btn-light form-control" style='color:white;'>REGISTRAR</button>
            </div>
        </form>
        </div>
      </div>
